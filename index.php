...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="icon" href="./logo-t-b.png">
  ...
  <body>
    ...
    <div class="container1">
        <div class="img-home">
            <img src="./assets/Asset 412.png" alt="home-img" class="log-img">
        </div>
     ...
     <form action="/loginsystem/index.php" method="post">
        ...
        <button type="submit" class="btns3">LOGIN</button>
        <a href="signup.php" class="btns4">SIGNUP</a>


        <!-- <button href="signup.php" class="btns4">SIGNUP</button> -->
